...
- **Domain layer (`prompts/system_prompt_<domain>.md`):**
  - 19 specialized prompts (P02–P20) routed via `system_prompt_router.md` v3.19.0-ROUTER, governed by §4.14 Domain Variant Contract
...
```
[PROTOCOL_STATUS: ACTIVE — v3.19.0]
